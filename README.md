...
### `说明：下载pycharm, 在windows下运行，所有代码中均已经配好路径，并附带数据集，直接打开对应的.py文件运行。`
...
### `思考：此处特征点的匹配和标定也可以使用opencv 包中的函数实现角点检测，提取两个特征点。但是，经过人工检查，效果并不好，两幅图中的特征点对应错误，如下。`

<img src="https://github.com/liangjiubujiu/light_field_low_rank_optimization/blob/master/images/45.jpg" width="600" />
